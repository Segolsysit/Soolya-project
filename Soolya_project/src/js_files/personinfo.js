  ...
  return (
    <div class="tab">
      <center>
        ...
        <TextField id="outlined-basic" label="Mobile Phone Number" variant="outlined" className='form-control w-75'
          value={formData.MobilePhoneNumber}
          onChange={(e) => {
            setformData({ ...formData, MobilePhoneNumber: e.target.value });
            setMobilePhoneNumbererror(false)
          }}
          error={MobilePhoneNumbererror}
          helperText={MobilePhoneNumbererror === true ? "Mobile Number is Required." : ""} /><br /><br /><br />
        ...
        <TextField id="outlined-basic" label="Street Address" variant="outlined" className='form-control w-75'
          ...
          helperText={StreetAddresserror === true ? "Street Address is Required." : ""} /><br /><br /><br />
        <TextField id="outlined-basic" label="Postal Code" variant="outlined" className='form-control w-75'
          ...
          helperText={PostalCodeerror === true ? "Postal Code is Required." : ""} /><br /><br /><br />
        {/* </div><br/> */}
      {/* <div className="ser_input_mail"> */}
        <TextField id="outlined-basic" label="Email" type="email" variant="outlined" className='form-control w-75'
          ...
          error={Emailerror}
          helperText={Emailerror === true ? "Email is Required." : ""} /><br /><br /><br />
      {/* </div><br /> */}
      </center>
